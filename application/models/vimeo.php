...
class Vimeo extends CI_Model {
  ...
  */
     ...
     * @return boolean true
     */
    public function setKeyToken($consumer_key, $consumer_secret, $token, $token_secret, $type = 'access', $session_store = false)
    {
    	$this->_consumer_key = $consumer_key;
        $this->_consumer_secret = $consumer_secret;
        $this->_token = $token;
